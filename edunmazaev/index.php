            ...
            <div class="hero-inner">
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>1. </span>Выберите ресторан</h4> </div>
                        <div class="step-item step2">
                            ...
                            <h4><span>2. </span>Закажите еду</h4> </div>
                        <div class="step-item step3">
                            ...
                            <h4><span>3. </span>Дождитесь доставки или заберите еду</h4> </div>
                    </div>
                </div>
            </div>
        </section>
						                       ...
						                       echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
														<div class="food-item-wrap">
															...
															<div class="content">
																...
																<div class="price-btn-block"> <span class="price">$'.$r['price'].'</span> <a href="dishes.php?res_id='.$r['rs_id'].'" class="btn theme-btn-dash pull-right">Заказать</a> </div>
															</div>
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <p>Мы предлогаем вам меню из разных ресторанов онлайн</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <h3>Заберите сами или выберите доставку</h3>
                                <p>Получите ваше блюдо и наслаждайтесь им</p>
                            </div>
                        </div>
                    </div>
                </div>
															...
															<div class="row">
																...
																<div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
																	...
																	<div class="bottom-part">
																		<div class="cost"><i class="fa fa-check"></i> Мин $ 10,00</div>
																		<div class="mins"><i class="fa fa-motorcycle"></i> 30 мин</div>
