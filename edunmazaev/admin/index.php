...
<div class="form">
  ...
  <form class="register-form" action="index.php" method="post">
    <input type="text" placeholder="Пользователь" name="cr_user"/>
    <input type="text" placeholder="email"  name="cr_email"/>
	 <input type="password" placeholder="Пароль"  name="cr_pass"/>
	  <input type="password" placeholder="Подтвердите пароль"  name="cr_cpass"/>
	  <input type="password" placeholder="Уникальный код"  name="code"/>
   <input type="submit"  name="submit1" value="Создать" />
    <p class="message">Уже зарегестрированы?<a href="#">Войдите</a></p>
  </form>
  ...
  <form class="login-form" action="index.php" method="post">
    ...
    <p class="message">Не зарегестрированы?<a href="#">Создайте аккаунт</a></p>
  </form>
</div>
